...
contract Ownable {
    ...
    modifier realAddress(address _address) {
        require(_address != address(0), "Address is not a real address");
        _;
    }

    event OwnershipTranerred(address indexed previousOwner, address indexed newOwner);
    ...
    realAddress(newOwner)
    {
        ...
        require(newOwner != _owner, "Can not transfer to the same address");

        address previousOwner = _owner;
        _owner = newOwner;

        emit OwnershipTranerred(previousOwner, newOwner);
    }
...
contract Pausable is Ownable {
    ...
    function setPause(bool status) public onlyOwner {
        ...
        require(_paused != status, "Same status");
...
//    @dev Approves another address to transfer the given token ID
    function approve(address to, uint256 tokenId) public {
        ...
        require(tokenOwner != to, "The given address can not be the owner of the token");

        // TODO require the msg sender to be the owner of the contract or isApprovedForAll() to be true
        require(msg.sender == tokenOwner || isApprovedForAll(tokenOwner, msg.sender), "Message sender needs to be the owner of the contract");
    ...
    // TIP: remember the functions to use for Counters. you can refresh yourself with the link above
    function _mint(address to, uint256 tokenId) internal realAddress(to) {
    ...
    // TIP: remember the functions to use for Counters. you can refresh yourself with the link above
    function _transferFrom(address from, address to, uint256 tokenId) internal realAddress(to) {

        // TODO: require from address is the owner of the given token
        require(_tokenOwner[tokenId] == from, "Invalid ownership");
